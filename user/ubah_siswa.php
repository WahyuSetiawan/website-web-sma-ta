...
<form action="proses_ubah_siswa.php" class="jNice" id="validasi" name="validasi" method="POST">
  	<table>
  	    <tr valign="top">
		...
		<tr valign="top">
   		<td>Password</td>
  		<td width="18">:&nbsp;</td>
  		<td><input name="password" class="text-long" size="30" id="password" value="<?php //echo $data['password']; ?>"/>
