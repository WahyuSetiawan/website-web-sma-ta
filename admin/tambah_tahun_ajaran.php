...
<form action="proses_tambah_tahun_ajaran.php" class="jNice" id="validasi" name="validasi" method="POST">
  	<table>
  	    <tr valign="top">
  		<td width="200" type="text">ID Tahun Ajaran  </td>
  		<td width="18">:&nbsp;</td>
  		<td width="173"><input type="text" size="30" name="id_thn_ajaran"/></td>
        </tr>
        <td width="200" type="text">Tahun Ajaran</td>
  		<td width="18">:&nbsp;</td>
  		<td width="173"><input name="thn_ajaran" size="30" class="text-medium" id="thn_ajaran"></td>
        </tr>
        <tr valign="top">
