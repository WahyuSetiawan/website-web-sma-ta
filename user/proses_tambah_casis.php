...
echo "<br>";
echo "<span class=link><a href=casis.php>ke data casis</a></span>";
}
//jika berhasil
else{
echo "<script>alert('Berhasil Mendaftar. Silahkan datang ke Sekolah untuk melengkapi Administrasi !'); window.location = 'casis.php'</script>";

echo "<span class=link><a href=casis.php>ke form tampil data </a></span>";
}
