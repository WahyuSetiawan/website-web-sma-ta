...
<div id="main">
  ...
  <div id="menu" class="box">
    <ul class="box">
	  ...
	  <li id="menu-active"><a href="all_fitur.php"><span>ARSIP</span></a></li> 
  ...
  <div id="cols" class="box">
    ...
    <div id="aside" class="box">
      ...
      <ul class="box">
        ...
        <li id="submenu-active"><a href="all_fitur.php">ARSIP</a>
          <!-- Active -->
		<li><a href="tampil_album.php">Album Foto</a></li>
        <li><a href="tampil_gallery.php">Gallery Foto</a></li>
        <li><a href="tampil_buku_tamu.php">Buku Tamu</a></li>
      </ul>
    </div>
    <!-- /aside -->
    <hr class="noscreen" />
