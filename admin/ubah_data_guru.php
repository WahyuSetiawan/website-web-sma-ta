...
$sql = "SELECT nip,nama,j_kelamin,tmp_lahir,tgl_lahir,agama,jabatan,mapel,alamat,tlp,email from guru where nip= '".$_GET['nip']."'";
...
<form action="proses_ubah_data_guru.php" class="jNice" id="validasi" name="validasi" method="POST">
  	<table>
  	    <tr valign="top">
