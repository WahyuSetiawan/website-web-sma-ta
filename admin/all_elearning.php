...
<div id="main">
  ...
  <div id="menu" class="box">
    <ul class="box">
	  ...
	  <li><a href="all_fitur.php"><span>ARSIB</span></a></li>
	  <li><a href="all_psb.php"><span>PSB</span></a></li>
	  <li id="menu-active"><a href="all_elearning.php"><span>MATERI</span></a></li>  
    </ul>
  </div>
  <!-- /header -->
  <hr class="noscreen" />
  ...
  <div id="cols" class="box">
    ...
    <div id="aside" class="box">
      ...
      <ul class="box">
        ...
        <li id="submenu-active"><a href="all_elearning.php">MATERI</a>
          <!-- Active -->
		<li><a href="tampil_elearning.php">Data Materi</a></li>
      </ul>
    </div>
    <!-- /aside -->
    <hr class="noscreen" />
