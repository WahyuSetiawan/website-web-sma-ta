...
// Upload gambar untuk struktur organisasi
function UploadStruktur($fupload_name){
  //direktori gambar
  $vdir_upload = "gambar_struktur/";
  $vfile_upload = $vdir_upload . $fupload_name;
...
// Upload gambar untuk elearning
function UploadElearning($fupload_name){
  //direktori gambar
  $vdir_upload = "file_elearning/";
  $vfile_upload = $vdir_upload . $fupload_name;
...
// Upload gambar untuk prestasi
function UploadProfil_Sekolah($fupload_name){
  //direktori gambar
  $vdir_upload = "gambar_prestasi/";
  $vfile_upload = $vdir_upload . $fupload_name;
...
// Upload gambar untuk album sarana
function UploadSarana($fupload_name){
  //direktori gambar
  $vdir_upload = "gambar_sarana/";
  $vfile_upload = $vdir_upload . $fupload_name;
...
// Upload gambar untuk album galeri foto
function UploadFotoSiswa($fupload_name){
  //direktori gambar
