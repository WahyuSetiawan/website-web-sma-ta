...
<div id="content" class="box">
    ...
    <label> <h2>Visi dan Misi Sekolah</h2></label>
    ...
    {
        $q=mysql_query("update profil_sekolah set entry_profil='".$_POST['editor1']."' where id_profil=1") or die(mysql_error());
       
        if($q)
        {
            echo "<script>alert('Berhasil diubah'); window.location = 'tampil_visi_misi.php'</script>";
        }
    }
    ?>
