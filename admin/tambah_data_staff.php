...
<form action="proses_tambah_data_staff.php" class="jNice" id="validasi" name="validasi" method="POST" enctype="multipart/form-data">
  	<table>
<tr valign="top">
  	 	<td>Foto Staff</td>
  		<td width="18">:&nbsp;</td>
 		<td> <input type=file name='fupload' size=15></td>    
  		...
  		<td width="18">:&nbsp;</td>
  		<td width="173"><input type="text" size="30" name="nik"/></td>
</tr>
 	    <tr valign="top">
