...
<div id="main">
  ...
  <div id="menu" class="box">
    <ul class="box">
	  ...
	  <li id="menu-active"><a href="all_profil.php"><span>PROFIL</span></a></li>
  ...
  <div id="cols" class="box">
    ...
    <div id="aside" class="box">
      ...
      <ul class="box">
        ...
        <li id="submenu-active"><a href="all_profil.php">PROFIL</a>
          <!-- Active -->
        <li><a href="tampil_visi_misi.php">Visi Misi</a></li>
        <li><a href="tampil_sejarah.php">Sejarah</a></li>
        <li><a href="tampil_struktur.php">Struktur Organisasi</a></li>
		<li><a href="tampil_prestasi.php">Prestasi Sekolah</a></li>
		<li><a href="tampil_sarana.php">Sarana dan Prasarana</a></li>
		<li><a href="tampil_tata_tertib.php">Tata Tertib</a></li>
		<li><a href="tampil_kontak.php">Kontak Sekolah</a></li>
      </ul>
    </div>
    <!-- /aside -->
    <hr class="noscreen" />
